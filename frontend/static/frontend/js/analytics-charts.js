...
(function () {
    ...
    let cities = ["Lagos", "Accra", "Dubai"].map(Bee.String.toSentenceCase);
    let splineChart = new Highcharts.Chart({
        ...
        xAxis: {
            categories: ['Codes Scanned', 'Cost Per Code', 'Cost Per Code'].map(Bee.String.toSentenceCase),
            title: {
                text: null
            },
            labels: {
    ...
    let doughnutChart = new Highcharts.Chart({
        ...
        series: [{
            data: [{name: "Lagos", y: 30}, {name: "Accra", y: 500}, {name: "Dubai", y: 43}]
        }]
    });
